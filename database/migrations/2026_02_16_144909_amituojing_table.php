...
return new class extends Migration
{
    ...
    {
        Schema::create('amituojing', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('audio_path')->nullable()->comment('Path file: audio/amituojing/nama.mp3');
    ...
    {
        Schema::dropIfExists('amituojing');
    }
};