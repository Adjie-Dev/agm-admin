...
return new class extends Migration
{
    ...
    {
        Schema::create('pathama_puja', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('audio_path')->nullable()->comment('Path file: audio/pathama/nama.mp3');
    ...
    {
        Schema::dropIfExists('pathama_puja');
    }
};
