    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                @if (session('success'))
                    <div class="bg-green-500/10 border-l-4 border-green-500 text-green-300 px-5 py-4 rounded-xl mb-6 flex items-center shadow-lg backdrop-blur-sm">
                ...
                @if (session('error'))
                    <div class="bg-red-500/10 border-l-4 border-red-500 text-red-300 px-5 py-4 rounded-xl mb-6 flex items-center shadow-lg backdrop-blur-sm">
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
