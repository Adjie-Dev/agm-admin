...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-slate-800/70 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 border border-slate-700/50 shadow-xl">
        <form action="{{ route('articles.update', $article) }}" method="POST" enctype="multipart/form-data" id="articleForm">
            ...
            <!-- Author -->
            <div class="mb-4 sm:mb-6">
                <label for="author" class="block text-xs sm:text-sm font-semibold text-gray-300 mb-2">
            ...
            <div class="mb-3 sm:mb-4">
                <label class="block text-xs sm:text-sm font-semibold text-gray-300 mb-2">Thumbnail Saat Ini</label>
                <img src="{{ asset('storage/' . $article->thumbnail) }}"
                     alt="{{ $article->title }}"
                     class="w-32 h-32 sm:w-48 sm:h-48 object-cover rounded-xl border border-slate-600">
            </div>
            @endif
                ...
                <div class="relative">
                    ...
                    <label for="thumbnail"
                        ...
                        <div class="text-center" id="upload-placeholder">
                            ...
                            <p class="text-xs sm:text-sm text-gray-400 mb-1">Klik untuk upload thumbnail baru</p>
            ...
            <div class="mb-4 sm:mb-6 p-3 sm:p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
                <div class="flex items-center space-x-2 text-green-400">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span class="font-semibold text-sm sm:text-base">Status: Published</span>
                </div>
                <p class="text-xs sm:text-sm text-gray-400 mt-1 ml-6 sm:ml-7">Dipublikasikan pada {{ $article->published_at->format('d M Y, H:i') }}</p>
            </div>
            @else
            <div class="mb-4 sm:mb-6 p-3 sm:p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-xl">
                <div class="flex items-center space-x-2 text-yellow-400">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    <span class="font-semibold text-sm sm:text-base">Status: Draft</span>
                </div>
                <p class="text-xs sm:text-sm text-gray-400 mt-1 ml-6 sm:ml-7">Artikel ini belum dipublikasikan</p>
            </div>
            @endif
