            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-900/50 border-b border-slate-700/50">
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Penulis</th>
                        <th class="px-6 py-4 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Dipublikasi</th>
                ...
                <tbody class="divide-y divide-slate-700/50">
                    ...
                    <tr class="hover:bg-slate-700/30 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-400">{{ $article->author }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($article->published_at)
                            <span class="px-3 py-1 text-xs font-semibold rounded-lg bg-green-500/10 text-green-400">
