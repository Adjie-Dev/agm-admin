...
@section('title', 'Puja Sore')

@section('header', 'Puja Sore')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-white mb-2">Daftar Puja Sore</h2>
            <p class="text-gray-400">Kelola konten audio Puja Sore</p>
        </div>
        <a href="{{ route('puja-sore.create') }}"
                    ...
                    <tr class="hover:bg-slate-700/30 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="{{ route('puja-sore.show', $puja) }}"
                                ...
                                <a href="{{ route('puja-sore.edit', $puja) }}"
                                ...
                                <form action="{{ route('puja-sore.destroy', $puja) }}" method="POST"
                                    class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center space-y-3">
                                ...
                                <p class="text-gray-400 text-lg">Belum ada data Puja Sore</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
