...
<div class="max-w-7xl mx-auto">
    ...
    <!-- Error Message -->
    @if(session('error'))
    <div class="mb-6 bg-red-500/10 border border-red-500/50 rounded-2xl p-4">
        <p class="text-red-400 font-medium">{{ session('error') }}</p>
    </div>
    @endif

    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-white">Semua E-Book</h2>
                    ...
                    <tr class="hover:bg-slate-700/30 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="{{ route('ebooks.destroy', $item) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center space-y-3">
                                ...
                                <p class="text-gray-400 font-medium">Belum ada e-book</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
