...
@section('header', 'Detail Dhammavācanā')
    ...
    <div class="mb-6">
        <a href="{{ route('dhammavachana.index') }}"
           class="inline-flex items-center space-x-2 text-gray-400 hover:text-white transition-colors duration-200">
            ...
            <span class="font-medium">Kembali ke Daftar Dhammavācanā</span>
        </a>
    </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="space-y-3 mb-6">
                        <div class="flex items-center text-gray-300">
                            ...
                            <span class="ml-2">{{ $dhammavachana->page_count }} halaman</span>
                        </div>
                        ...
                        <div class="flex items-center text-gray-300">
                            ...
                            <span class="ml-2">{{ $dhammavachana->uploader->name ?? 'Unknown' }}</span>
                        </div>
                        ...
                        <div class="flex items-center text-gray-300">
                            ...
                            <span class="ml-2">{{ $dhammavachana->created_at->format('d M Y, H:i') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-slate-700 pt-6">
                        ...
                        <p class="text-gray-300 leading-relaxed whitespace-pre-wrap">{{ $dhammavachana->description }}</p>
                    </div>
                    @endif
