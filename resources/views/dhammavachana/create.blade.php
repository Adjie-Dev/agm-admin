...
@section('title', 'Tambah Dhammavācanā')

@section('header', 'Tambah Dhammavācanā Baru')
        ...
        <form action="{{ route('dhammavachana.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="number"
                       ...
                       min="1">
                <p class="mt-2 text-xs text-gray-500">Akan otomatis terdeteksi dari PDF jika tidak diisi</p>
                @error('page_count')
                <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-8">
                <label for="pdf_file" class="block text-sm font-semibold text-gray-300 mb-2">
                    File PDF <span class="text-red-400">*</span>
                </label>
                <div class="relative">
                    <input type="file"
                           name="pdf_file"
                    ...
                    <label for="pdf_file"
                        ...
                        <div class="text-center" id="upload-placeholder">
                            ...
                            <p class="text-sm text-gray-400 mb-1">Klik untuk upload file PDF</p>
